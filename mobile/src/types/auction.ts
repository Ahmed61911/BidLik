/**
 * Domain types — ported from webapp/src/types/auction.ts.
 * Mirror the shared Supabase backend contract; keep in sync with the webapp.
 */
...
export interface Car {
  ...
  images: string[];
  /** Photos submitted by the expert during inspection (admin/expert/buyer-of-record only). */
  expertImages?: string[];
}
...
/**
 * AuctionEvent — groups multiple car lots into a single sale window.
