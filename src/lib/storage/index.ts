...
import { LocalFilesystemStorageProvider } from "./providers/localFilesystemStorage";
...
/* ─────────── Swap point ─────────── */
const provider: StorageProvider = new LocalFilesystemStorageProvider();
...
export interface UploadFileInput {
  ...
  /** Optional car linkage for the metadata row (see UploadOptions.carId). */
  carId?: string;
